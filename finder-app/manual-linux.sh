...
# Use first argument as OUTDIR if provided, otherwise default to /tmp/aeld
OUTDIR=${1:-/tmp/aeld}
...
if ! command -v ${CROSS_COMPILE}gcc >/dev/null 2>&1; then
    ...
    echo "Please install it or add its bin directory to PATH."
    exit 1
fi
